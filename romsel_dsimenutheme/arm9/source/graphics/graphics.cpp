...
int subBgTexID, mainBgTexID, shoulderTexID, bubbleTexID, progressTexID, dialogboxTexID, wirelessiconTexID;
...
// Need more palette memory for fonts. // Allocate VRAM bank for all the palettes
//	vramSetBankH(VRAM_H_SUB_BG_EXT_PALETTE); // Not sure this does anything... 
	...
	dialogboxTexID = glLoadTileSet(dialogboxImage, // pointer to glImage array
							...
							(u16*) dialogboxPal, // Load our 4 color tiles palette
	...
	if (theme == 1) {
		...
		braceTexID = glLoadTileSet(braceImage, // pointer to glImage array
								...
								GL_TEXTURE_WRAP_S | GL_TEXTURE_WRAP_T | TEXGEN_OFF | GL_TEXTURE_COLOR0_TRANSPARENT, // param for glTexImage2D() in videoGL.h
								4, // Length of the palette to use (16 colors)
								(u16*) org_bracePal, // Load our 4 color tiles palette
